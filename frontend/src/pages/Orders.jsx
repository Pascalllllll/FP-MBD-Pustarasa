  ...
  return (
    <div>
      <PageHeader
        title="Kasir & Pesanan"
        service="kantin"
        description="Setiap penjual punya menunya sendiri. Pilih penjual untuk membuka kasirnya, lalu buat pesanan — header lewat sp_checkout_pesanan, item divalidasi trigger dalam transaksi yang sama; menu habis otomatis ditolak."
        actions={
